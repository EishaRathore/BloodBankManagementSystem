...
{
    public partial class BecomeDonor : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)              //select Image Button
        {
            ...
            if (fulln != null && email != null && add != null && gender != null && mbl != null && dateTimePicker1 != null && bloodg != null && ellig != null && imgName != null)
            {
                ...
                if (success == true)
                {
                    ...
                    //data or user added successfully
                     this.Hide();
                    SignUpPOPUP f1 = new SignUpPOPUP(fulln.Text);
                    f1.Show();
                }
                else
                {
        ...
        private void BecomeDonor_Load(object sender, EventArgs e)
        {
            //first we need to get the image path
            string paths = Application.StartupPath.Substring(0, Application.StartupPath.Length - 10);
